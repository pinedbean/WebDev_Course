...
Track the build & learning status of every chunk. Each chunk has three HTML deliverables:
**Lecture** (`lecture.html`) · **Assignment** (`assignment.html`) · **Solution** (`solution.html`).

### Legend
- **Build status:** ⬜ Not started · 🟡 In progress · ✅ Done
- **File columns:** ⬜ = not created · ✅ = created
- **Learned:** ⬜ = not yet · ✅ = studied & lab completed by learner
